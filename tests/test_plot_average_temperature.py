...
def tests_get_monthly_temperature_by_year():
    ...
    obtained_data_to_plot = get_monthly_temperature_by_year(monthly_average_rain_path, year)
...
def test_get_box_plot_data_temperature():
    monthly_average_rain_path = "tests/data/input_plot_average_rain_by_zone.csv"
    obtained_box_plot_data = get_box_plot_data_temperature(monthly_average_rain_path)

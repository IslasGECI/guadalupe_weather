...
def test_get_box_plot_data_temperature():
    ...
    obtained_box_plot_data = xxget_box_plot_data_without_nan(monthly_average_rain_df, variable)
...
def test_get_multiannual_monthly_temperature():
    ...
    years = [2017]
    obtained_data_to_plot = get_multiannual_monthly_temperature(monthly_average_rain_df, years)

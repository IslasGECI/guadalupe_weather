...
## [0.4.1] - 2026-07-13
### Changed
- `remove-outliers` and `remove-outliers-for-column` CLI commands now automatically rename the `Fecha` column to `Date`, accepting raw weather station CSV data directly.
